...
public class LoginControllerTests {
    ...
    @Test
    public void login_EmptyUsername_ShouldThrowBadRequest() {
        // Arrange
        LoginRequest request = createLoginRequest("", "testPassword");
    ...
    @Test
    public void login_EmptyPassword_ShouldThrowBadRequest() {
        // Arrange
        LoginRequest request = createLoginRequest("testUser", "");
