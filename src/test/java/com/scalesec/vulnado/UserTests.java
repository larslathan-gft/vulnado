...
public class VulnadoApplicationTests {
    ...
    public void assertAuth_ShouldNotThrowExceptionForValidToken() {
        ...
        try {
            ...
            fail("Authorization should not fail for a valid token");
        }
    }
    ...
    public void fetch_ShouldReturnUserForValidUsername() throws SQLException {
        ...
        assertNotNull("User should be fetched successfully", user);
    ...
    public void fetch_ShouldReturnNullForInvalidUsername() throws SQLException {
        ...
        assertNull("User should not be fetched for invalid username", user);
    }
}
